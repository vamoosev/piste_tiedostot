...
class lenghtofc(Scene):
    def construct(self):
        ...
        self.wait(.25)
        area_a = Square(side_length=2, fill_color=BLUE, fill_opacity=0.2)
        area_b = Square(side_length=2, fill_color=BLUE, fill_opacity=0.2)
        area_c = Square(side_length=2, fill_color=BLUE, fill_opacity=0.2).rotate(PI/4).next_to(truangl, LEFT).shift(RIGHT*.5)
